...
/* themes/lamirada/templates/content/splide-wrapper.html.twig */
class __TwigTemplate_4204d537df0e31dda35a690ea9c33901 extends Template
{
...
($context["settings"] ?? null), "navpos", [], "any", false, false, true, 25))) ? (("is-wrapper-nav--" . Twig\Extension\CoreExtension::replace(CoreExtension::getAttribute($this->env, $this->source, ($context["settings"] ?? null), "navpos", [], "any", false, false, true, 25), ["over-" => ""]))) : (""))];
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["blazies"] ?? null), "is", [], "any", false, false, true, 28), "nav", [], "any", false, false, true, 28)) {
            ...
            yield ">";
            // line 30
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, (($_v0 = ($context["items"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess && in_array($_v0::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v0[1] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), 1, [], "array", false, false, true, 30)), "html", null, true));
            // line 31
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, (($_v1 = ($context["items"] ?? null)) && is_array($_v1) || $_v1 instanceof ArrayAccess && in_array($_v1::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v1[0] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), 0, [], "array", false, false, true, 31)), "html", null, true));
            // line 32
            yield "</div>
";
        } else {
            // line 34
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, (($_v2 = ($context["items"] ?? null)) && is_array($_v2) || $_v2 instanceof ArrayAccess && in_array($_v2::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v2[1] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), 1, [], "array", false, false, true, 34)), "html", null, true));
            // line 35
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar($this->extensions['Drupal\gin_lb\TwigExtension\GinLbExtension']->escapeFilter($this->env, (($_v3 = ($context["items"] ?? null)) && is_array($_v3) || $_v3 instanceof ArrayAccess && in_array($_v3::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v3[0] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["items"] ?? null), 0, [], "array", false, false, true, 35)), "html", null, true));
        }
    ...
    {
        return "themes/lamirada/templates/content/splide-wrapper.html.twig";
    }
    ...
    {
        return array (  70 => 35,  68 => 34,  64 => 32,  62 => 31,  60 => 30,  56 => 29,  54 => 28,  52 => 25,  51 => 24,  50 => 23,  49 => 22,  48 => 21,  47 => 20,  46 => 19,  45 => 18,  44 => 16,);
    }

    public function getSourceContext(): Source
    {
        return new Source("", "themes/lamirada/templates/content/splide-wrapper.html.twig", "/var/www/html/web/themes/lamirada/templates/content/splide-wrapper.html.twig");
    }
