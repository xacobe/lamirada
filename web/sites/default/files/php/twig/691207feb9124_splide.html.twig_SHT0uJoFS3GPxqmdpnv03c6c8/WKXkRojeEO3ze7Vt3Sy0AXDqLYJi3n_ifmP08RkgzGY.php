...
class __TwigTemplate_ce74e57b7296a06e2f11417fb008a131 extends Template
{
...
($context["settings"] ?? null), "attributes", [], "any", false, false, true, 61), "class", [], "any", false, false, true, 61)) ? (Twig\Extension\CoreExtension::join(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["settings"] ?? null), "attributes", [], "any", false, false, true, 61), "class", [], "any", false, false, true, 61), " ")) : (""))];
  ...
  ";
        ...
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["splides"] ?? null), "use", [], "any", false, false, true, 71), "slider", [], "any", false, false, true, 71)) {
            // line 72
            yield "<div";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["content_attributes"] ?? null), "addClass", ["splide__slider"], "method", false, false, true, 72), "html", null, true);
            yield ">";
        }
        // line 80
...
";
    ...
    public function block_splide_content(array $context, array $blocks = []): iterable
    {
      ...
      <ul";
        // line 67
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["list_attributes"] ?? null), "html", null, true);
        yield ">";
  ...
  ";
    ...
    public function block_splide_autoplay(array $context, array $blocks = []): iterable
    {
        ...
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Pause autoplay"));
        yield "\">
    ...
    public function block_splide_arrow(array $context, array $blocks = []): iterable
    {
        ...
        // line 99
        yield "    <div";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["arrows_attributes"] ?? null), "html", null, true);
        yield "></div>";
        // line 100
        if (array_key_exists("arrow_down_attributes", $context)) {
            // line 101
            yield "<button";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["arrow_down_attributes"] ?? null), "addClass", ["splide__arrow--down"], "method", false, false, true, 101), "setAttribute", ["type", "button"], "method", false, false, true, 101), "setAttribute", ["data-target", CoreExtension::getAttribute($this->env, $this->source,             // line 103
...
($context["settings"] ?? null), "downOffset", [], "any", false, false, true, 104)], "method", false, false, true, 103), "html", null, true);
    ...
    public function block_splide_pagination(array $context, array $blocks = []): iterable
    {
        ...
        // line 108
        yield "    <ul";
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, ($context["pagination_attributes"] ?? null), "html", null, true);
        yield "></ul>
  ";
        yield from [];
    }
