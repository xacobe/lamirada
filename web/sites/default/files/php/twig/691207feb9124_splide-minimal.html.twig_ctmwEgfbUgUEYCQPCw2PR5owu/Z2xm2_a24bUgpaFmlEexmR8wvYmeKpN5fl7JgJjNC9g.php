...
class __TwigTemplate_d71b6b9cee2c11f119b786c9dc906ff8 extends Template
{
...
($context["delta"] ?? null))];
        ...
        if ((CoreExtension::getAttribute($this->env, $this->source, ($context["settings"] ?? null), "current_item", [], "any", false, false, true, 31) == "nav")) {
            ...
            if (($context["use_blazy"] ?? null)) {
                ...
                if ( !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "slide", [], "any", false, false, true, 37))) {
                    ...
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "slide", [], "any", false, false, true, 38), "html", null, true);
                    yield "</div>";
                }
                // line 40
                if ( !Twig\Extension\CoreExtension::testEmpty(CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "caption", [], "any", false, false, true, 40))) {
                    ...
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["item"] ?? null), "caption", [], "any", false, false, true, 41), "html", null, true);
                    yield "</div>";
                }
            }
        } else {
    ...
    {
        return array (  98 => 48,  95 => 46,  93 => 45,  86 => 41,  84 => 40,  79 => 38,  77 => 37,  75 => 36,  72 => 34,  70 => 33,  68 => 31,  62 => 30,  50 => 29,  48 => 28,  46 => 25,  45 => 24,);
    }
